Here is a summary of all the Data Science projects i've made so far :
---

| Title & link | Year | Source | Description  | 
| --- | --- | --- | --- |
...
| [Handwritten Digit Generation](https://github.com/obrunet/Kaggle_kernels/blob/master/Digit_generator/kaggle/Digit-Generator.ipynb) | 2019 | Kaggle | Unsupervised deep learning with G.A.N - training of a Generator and a Discriminator with the famous MNIST data set |
